...
| Usare un articolo | Al comando <code>use</code> l'applicazione deve usare le proprietà dell'articolo, se non ci <br>sono oggetti è mostrato il messaggio <br><code>Nel tuo inventario non è presente l'oggetto</code> e l'applicazione rimane in attesa <br>di un comando valido. E possibile usare al massimo due articoli contemporaneamente |
