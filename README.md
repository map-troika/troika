...
| Prendere un articolo | Al comando <code>take</code> l'applicazione deve prendere l'articolo, porlo nell'inventario <br>ed eliminarlo dalla stanza, se non ci sono oggetti è mostrato il messaggio <br><code>In questa stanza non è presente l'oggetto</code> e l'applicazione rimane in attesa di un comando valido. |
