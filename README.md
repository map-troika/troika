...
| Prendere un articolo | Al comando <code>take</code> l'applicazione deve prendere l'articolo, porlo nell'inventario ed<br> eliminarlo dalla stanza, se non ci sono oggetti è mostrato il messaggio <code>In questa</code><br> <code>stanza non è presente l'oggetto</code> e l'applicazione rimane in attesa di un<br> comando valido. |
