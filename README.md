...
| Muovere a Ovest | Al comando <code>west</code> l'applicazione deve muovere il giocatore verso Ovest, <br>se l'uscita non è valida è mostrato il messaggio <code>C'è un muro da questa parte!</code> <br>e l'applicazione rimane in attesa di un comando valido. |
