...
| Iniziare una nuova partita | Al comando <code>play</code> l'applicazione si deve predisporre a ricevere comandi <br>tra cui <br>la prima mossa del bianco ed è in grado di ricevere altri comandi <br>di gioco (es. <code>show</code>). |
...
| Muovere a Nord | Al comando <code>north</code> l'applicazione deve muovere il giocatore verso Nord, se <br>l'uscita non è valida è mostrato il messaggio <code>C'è un muro da questa parte!</code> <br>e l'applicazione rimane in attesa di un comando valido. |
| Muovere a Sud | Al comando <code>south</code> l'applicazione deve muovere il giocatore verso Sud, se <br>l'uscita non è valida è mostrato il messaggio <code>C'è un muro da questa parte!</code> <br>e l'applicazione rimane in attesa di un comando valido. |
| Muovere a Est | Al comando <code>east</code> l'applicazione deve muovere il giocatore verso Est, se <br>l'uscita non è valida è mostrato il messaggio <code>C'è un muro da questa parte!</code> <br>e l'applicazione rimane in attesa di un comando valido. |
| Muovere a Ovest | Al comando <code>west</code> l'applicazione deve muovere il giocatore verso Ovest, se <br>l'uscita non è valida è mostrato il messaggio <code>C'è un muro da questa parte!</code> <br>e l'applicazione rimane in attesa di un comando valido. |
